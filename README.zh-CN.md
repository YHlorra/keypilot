...
<p align="center">
  ...
  <img alt="版本" src="https://img.shields.io/badge/version-0.1.0-000?style=flat-square"/>
...
- **24 个 Provider 预设** —— Anthropic、OpenAI、DeepSeek、GitHub Models、Volcengine、Kimi、GLM、MiniMax、ZenMux 等。每个预设自带字段模板与额度接口。
- **11 个 Coding Plan 追踪** —— Kimi For Coding、GLM Coding、MiniMax Token Plan、Volcengine Ark Coding Plan、ZenMux 的 5h + 周窗口。
...
依次执行 `cargo check`、`cargo test`、`pnpm install && tsc --noEmit`。
...
| 版本 | 重点 |
|---|---|
| V0.2 | SQLCipher / 主密码 Argon2id / DPAPI 评估;自动刷新;低额度告警;导入导出 |
| V0.3 | macOS / Linux 支持 |
| V1.0 | 稳定 API、签名发布、自动更新通道 |
